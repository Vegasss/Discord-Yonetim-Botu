...
module.exports = async () => {
  ...
  console.log(`VEGASSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS (${client.user.username}) adlı hesapta [${client.guilds.cache.get(cfg.Server.GuildID).name}] adlı sunucuda giriş yapıldı. ✔`)}
